            ...
            <div id="content">
                <div class="hero-unit-table"> 
                    ...
                    <div id="body">
                        ...
                        <ul class="thumbnails">
                            <?php
                            $query = mysql_query("select * from tb_products WHERE category = 'he19'") or die(mysql_error());
                            while ($row = mysql_fetch_array($query)) {
                                ...
                                <li class="span3">
                                    ...
                                    if (isset($_POST['order'])) {
                                     ...
                                     /*    header('location:user_all_books.php'); */
										?>
												<script>
																window.location = 'user_he19.php';				
																</script>
										<?php
                                    }
                                    ?>
